    ...
    <div class="concl-comparison">
      <div class="concl-comp-col">
        ...
        ${[
          ...
          ["Восприятие коррупции (TI CPI, 2025)", "78/100"],
          ["Верховенство закона (WJP, 2024)", "0.83/1.0"],
          ["Гражданские свободы (FH, 2025)", "40/40"],
          ["Честность выборов", "Без существенных оговорок"],
      ...
      <div class="concl-comp-col">
        ...
        ${[
          ...
          ["Восприятие коррупции (TI CPI, 2025)", "22/100, 157-е место"],
          ["Верховенство закона (WJP, 2024)", "0.34/1.0"],
          ["Гражданские свободы (FH, 2025)", "5/40"],
          ["Честность выборов", "Систематические нарушения"],
          ["Смена власти", "Не было с 1999-го"],
          ["Политзаключённые", "700+ (Мемориал, до ликвидации)"],
          ["Независимость суда", "99.6% обвинительных приговоров"],
